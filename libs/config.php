...
// URL DNS
define('IP','http://tv.nowiptv.net:8880'); 

//pink, aqua, orange or blue themes
$template = 'blue'; 

// WhatsApp Number
define("WHATSAPP", ''); //85998595700

// Website 
define("NOME_IPTV", 'CFSPLAYER'); 
...
define("EMAIL_ASSUNTO", 'Bem Vindo ao ITV - CFSPLAYER');
define("EMAIL_REVENDA", 'contato@revenda.com');
define("NOME_REVENDA", 'CFSPLAYER');
...
define("CORPO_EMAIL", "Olá %NOME%, seu teste foi criado com sucesso.<br><br>
    Você pode fazer seu login em nosso CFSPLAYER utilizando os seguintes dados:<br>
    <br>
